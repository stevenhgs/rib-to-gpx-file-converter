...
def get_raw_track_points(file: BinaryIO, mode: int) -> list[list[int]]:
    """
    This method assumes the given file is a .rib file generated by goggles of Recon Instruments.
    ...
    Mode 1 should be used for files generated by the Snow2 goggles.
    Mode 2 should be used for files generated by the Zeal Optics Transcend goggles.
    """
...
def get_coordinate_from_four_bytes(values: tuple[int, int, int, int]) -> float:
    """
    The given values parameter is a tuple of 4 integer values.
...
def get_track_points_from_raw_track_points(raw_track_points: list[list[int]]) -> list[dict]:
    ...
    A raw track point is a list of 24 (mode 2) or 32 (mode 1) integer values with each integer value between 0 and 255.
...
def generate_gpx_text(track_points: list[dict]) -> str:
    ...
    Then for every track point in track_points a <trkpt> tag with its corresponding data is added to the gpx text.
...
def convert_rib_to_gpx_file(input_file_path_string: str | None, mode_string: str | None, output_file_path_string: str | None = None) -> None:
    """
    This method assumes the given input_file is a .rib file generated by goggles of Recon Instruments.
    This method will convert the given input_file into a .gpx file with an output_file_name if it is given.
