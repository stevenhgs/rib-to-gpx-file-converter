...
With this the support to convert .rib files to .gpx files also was dropped.

This Python project converts .rib files generated by smartglasses of Recon Instruments to .gpx files. 
